...
def build_copy_path(path):
    ...
    elif "ood_intermediate" in model_path:
        copy_path += "ood_intermediate/"
    else:
        return "failure"
...
state_types = ["raw_no_intermediate", "ood_ood", "ood_intermediate", "raw_intermediate"]
model_types = ["CQL", "DQN"]
run_num = 5
